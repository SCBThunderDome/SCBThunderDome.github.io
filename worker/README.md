...
2. Name: anything (`SCB Thunderdome Live`)
...
2. Name it `scb-thunderdome-live`, deploy the default hello-world
...
Copy the Worker URL (`https://scb-thunderdome-live.<your-subdomain>.workers.dev`)
into `people.js`:

```js
const LIVE_STATUS = {
  endpoint: "https://scb-thunderdome-live.your-subdomain.workers.dev",
  refreshSeconds: 120,
};
```
...
```
https://scb-thunderdome-live.<sub>.workers.dev/?logins=rycr0sby,jakefols
```

Expected: `{"live":["jakefols"],"checked":2,"ts":1753142400}`

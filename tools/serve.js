...
server.listen(PORT, () => {
  console.log(`
  SCB Thunderdome — local preview

    http://localhost:${PORT}/                 root (redirects)
    http://localhost:${PORT}/scbthunderdome/  the league
    http://localhost:${PORT}/admin/           commissioner tools
    http://localhost:${PORT}/logo-check.html  verify espnId logos

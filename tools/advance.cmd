...
echo.
echo   ============================================
echo    SCB THUNDERDOME - ADVANCE
echo   ============================================
echo.

echo   (The advance posts to Discord. To skip the post on a given run
echo    - say the webhook's down - answer n at the push prompt, or run
echo    advance.js by hand with --no-post.)
echo.
rem One league, so nothing to pick. Adding a second means restoring a
rem prompt here and a line in LEAGUES in tools/lib/league.js.
set "LEAGUE=scbthunderdome"
set "POSTFLAG="
